...
{
    [TestClass]
    public class CoarseSynchronizedBinarySearchTreeTests
    {
        private CoarseSynchronizedBinarySearchTree<int, int> SequentialCreateCSBST(int[] requests)
        {
            var tree = new CoarseSynchronizedBinarySearchTree<int, int>();
            var k = 0;
        ...
        private CoarseSynchronizedBinarySearchTree<int, int> ParallelCreateCSBST(int[] requests)
        {
            var tree = new CoarseSynchronizedBinarySearchTree<int, int>();
            var amountThreads = 4;
        ...
        {
            var tree = SequentialCreateCSBST(requests);
        ...
        {
            var tree = ParallelCreateCSBST(requests);
            Assert.IsTrue(tree.Root == null || CheckLinksFatherSon(tree.Root));
